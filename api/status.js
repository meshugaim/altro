// GET /api/status?id=123  ->  { status, file_url? }
// Lightweight poll target — checks a Skybox generation's status. Always <1s.
...
export default async function handler(req, res){
  ...
  const r = await fetch(`https://backend.blockadelabs.com/api/v1/imagine/requests/${encodeURIComponent(id)}`, {
